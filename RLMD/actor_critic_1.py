...
def main(args):
    ...
    for i in range(max_episode):
        ...
        for timestep in range(1, max_steps_per_episode):
            ...
            state_history.append(tf.stop_gradient(state))
        ...
        with tf.GradientTape() as t:
            ...
            loss_value = actor_loss +0.5*critic_loss + entropy_loss
    ...
    model.save('ac_mu_'+str(int(10*float(args['mu'])))+'_model_rs_'+str(random_seed)+'_1'+'.h5')
    with open('ac_mu_'+str(int(10*float(args['mu'])))+'_solution_'+str(random_seed)+'_1', 'wb') as fp:
